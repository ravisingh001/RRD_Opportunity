...
public class Lead_Config27 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Lead_Configuration27.html");
		logger = report.startTest("Verify Lead Configuration27");
	...
	@Test
	public void Test_Config27() throws InterruptedException {

		Xls_Reader reader = new Xls_Reader(Lead_Testdata_sheet_path);

		int rowCount = reader.getRowCount("Lead_Config27");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			String sUser1 = reader.getCellData("Lead_Config27", "Enable_RRD_Users", rowNum);
			String sOwnerNotification = reader.getCellData("Lead_Config27", "ownerNotification", rowNum);
			String sReleationshipBasedAssignment = reader.getCellData("Lead_Config27", "Rel_Based_Asgmt", rowNum);
			String EO_RBA_LeadField = reader.getCellData("Lead_Config27", "EO_Lead Fields", rowNum);
			String EO_RBA_OpportunityField = reader.getCellData("Lead_Config27", "EO_Opportunity Fields", rowNum);
			...
			int Criteriacount = Reader.getRowCount("Lead_Config27_1_CL");
			...
			for (int rownumt = 2; rownumt <= Criteriacount; rownumt++) {
				try {
					String Scriteria = Reader.getCellData("Lead_Config27_1_CL", "RRD_Crieteria", rownumt);
					String Soperator = Reader.getCellData("Lead_Config27_1_CL", "RRD_operator", rownumt);
					String Sfieldval = Reader.getCellData("Lead_Config27_1_CL", "RRD_fieldvalue", rownumt);
					 //String logic = Reader.getCellData("Lead_Config27_1_CL", "CriteriaLogic", rownumt);
			...
			for (int rownumt = 2; rownumt <= Criteriacount; rownumt++) {
				try {
					String Scriteria = Reader.getCellData("Lead_Config27_2_CL", "RRD_Crieteria", rownumt);
					String Soperator = Reader.getCellData("Lead_Config27_2_CL", "RRD_operator", rownumt);
					String Sfieldval = Reader.getCellData("Lead_Config27_2_CL", "RRD_fieldvalue", rownumt);
					 String logic = Reader.getCellData("Lead_Config27_2_CL", "CriteriaLogic", rownumt);
