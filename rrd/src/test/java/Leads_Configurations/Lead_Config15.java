...
public class Lead_Config15 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Lead_Configuration15.html");
		logger = report.startTest("Verify Lead Configuration15");
	...
	@Test
	public void Test_Config15() throws InterruptedException {

		Xls_Reader reader = new Xls_Reader(Lead_Testdata_sheet_path);

		int rowCount = reader.getRowCount("Lead_Config15");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			String sUser1 = reader.getCellData("Lead_Config15", "Enable_RRD_Users", rowNum);
			String sOwnerNotification = reader.getCellData("Lead_Config15", "ownerNotification", rowNum);
			String sReleationshipBasedAssignment = reader.getCellData("Lead_Config15", "Rel_Based_Asgmt", rowNum);
			String EO_RBA_LeadField = reader.getCellData("Lead_Config15", "EO_Lead Fields", rowNum);
			String EO_RBA_OpportunityField = reader.getCellData("Lead_Config15", "EO_Opportunity Fields", rowNum);
