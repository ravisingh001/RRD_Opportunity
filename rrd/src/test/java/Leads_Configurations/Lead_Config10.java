...
public class Lead_Config10 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Lead_Configuration10.html");
		logger = report.startTest("Verify Lead Configuration10");
	...
	@Test
	public void Test_Config10() throws InterruptedException {

		Xls_Reader reader = new Xls_Reader(Lead_Testdata_sheet_path);

		int rowCount = reader.getRowCount("Lead_Config10");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			String sUser1 = reader.getCellData("Lead_Config10", "Enable_RRD_Users", rowNum);
			String sOwnerNotification = reader.getCellData("Lead_Config10", "ownerNotification", rowNum);
			String sReleationshipBasedAssignment = reader.getCellData("Lead_Config10", "Rel_Based_Asgmt", rowNum);
			String RBA_LeadField = reader.getCellData("Lead_Config10", "Lead Fields", rowNum);
