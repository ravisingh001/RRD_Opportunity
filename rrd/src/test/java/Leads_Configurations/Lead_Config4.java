...
public class Lead_Config4 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Lead_Configuration4.html");
		logger = report.startTest("Verify Lead Configuration4");
	...
	@Test
	public void Test_Config3() throws InterruptedException {

		Xls_Reader reader = new Xls_Reader(Lead_Testdata_sheet_path);

		int rowCount = reader.getRowCount("Lead_Config4");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			String sUser1 = reader.getCellData("Lead_Config4", "Enable_RRD_Users", rowNum);
			String sOwnerNotification = reader.getCellData("Lead_Config4", "ownerNotification", rowNum);
			String sReleationshipBasedAssignment = reader.getCellData("Lead_Config4", "Rel_Based_Asgmt", rowNum);
			...
			step1ConfigPage.QueueAssignment_Checked();
