...
public class Lead_Config9 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Lead_Configuration9.html");
		logger = report.startTest("Verify Lead Configuration9");
	...
	@Test
	public void Test_Config9() throws InterruptedException {

		Xls_Reader reader = new Xls_Reader(Lead_Testdata_sheet_path);

		int rowCount = reader.getRowCount("Lead_Config9");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			String sUser1 = reader.getCellData("Lead_Config9", "Enable_RRD_Users", rowNum);
			String sOwnerNotification = reader.getCellData("Lead_Config9", "ownerNotification", rowNum);
			String sReleationshipBasedAssignment = reader.getCellData("Lead_Config9", "Rel_Based_Asgmt", rowNum);
			String RBA_LeadField = reader.getCellData("Lead_Config9", "Lead Fields", rowNum);
