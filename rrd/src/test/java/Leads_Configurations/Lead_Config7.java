...
public class Lead_Config7 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Lead_Configuration7.html");
		logger = report.startTest("Verify Lead Configuration7");
	...
	@Test
	public void Test_Config7() throws InterruptedException {

		Xls_Reader reader = new Xls_Reader(Lead_Testdata_sheet_path);

		int rowCount = reader.getRowCount("Lead_Config7");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			String sUser1 = reader.getCellData("Lead_Config7", "Enable_RRD_Users", rowNum);
			String sOwnerNotification = reader.getCellData("Lead_Config7", "ownerNotification", rowNum);
			String sReleationshipBasedAssignment = reader.getCellData("Lead_Config7", "Rel_Based_Asgmt", rowNum);
			String RBA_LeadField = reader.getCellData("Lead_Config7", "Lead Fields", rowNum);
