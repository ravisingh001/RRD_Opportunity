...
public class Lead_Config12 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Lead_Configuration12.html");
		logger = report.startTest("Verify Lead Configuration12");
	...
	@Test
	public void Test_Config12() throws InterruptedException {

		Xls_Reader reader = new Xls_Reader(Lead_Testdata_sheet_path);

		int rowCount = reader.getRowCount("Lead_Config12");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			String sUser1 = reader.getCellData("Lead_Config12", "Enable_RRD_Users", rowNum);
			String sOwnerNotification = reader.getCellData("Lead_Config12", "ownerNotification", rowNum);
			String sReleationshipBasedAssignment = reader.getCellData("Lead_Config12", "Rel_Based_Asgmt", rowNum);
			String EO_RBA_LeadField = reader.getCellData("Lead_Config12", "EO_Lead Fields", rowNum);
			String EO_RBA_OpportunityField = reader.getCellData("Lead_Config12", "EO_Opportunity Fields", rowNum);
