...
public class Opp_Allocation_config2 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/opportunityCreation2.html");
		logger = report.startTest("Verify opportunity Creation2");
	...
	@Test
	public void OpportunityCreation_config2() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Opp_Allocation_config2");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("Opp_Allocation_config2", "Amount", rowNum);
				String Closedate = reader.getCellData("Opp_Allocation_config2", "Close date", rowNum);
				String Stages = reader.getCellData("Opp_Allocation_config2", "Stages", rowNum);
				String OpportunityName = reader.getCellData("Opp_Allocation_config2", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("Opp_Allocation_config2", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("Opp_Allocation_config2", "Ratingtype", rowNum);
				String RRD_Type = reader.getCellData("Opp_Allocation_config2", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("Opp_Allocation_config2", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("Opp_Allocation_config2", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("Opp_Allocation_config2", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("Opp_Allocation_config2", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("Opp_Allocation_config2", "ToBeAssigned", rowNum);
