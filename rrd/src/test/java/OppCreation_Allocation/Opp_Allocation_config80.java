...
public class Opp_Allocation_config80 {
	...
	@Test
	public void OpportunityCreation_config80() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Opp_Allocation_config80");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("Opp_Allocation_config80", "Amount", rowNum);
				String Closedate = reader.getCellData("Opp_Allocation_config80", "Close date", rowNum);
				String Stages = reader.getCellData("Opp_Allocation_config80", "Stages", rowNum);
				String OpportunityName = reader.getCellData("Opp_Allocation_config80", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("Opp_Allocation_config80", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("Opp_Allocation_config80", "Ratingtype", rowNum);
				//String RRD_Type = reader.getCellData("Opp_Allocation_config80", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("Opp_Allocation_config80", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("Opp_Allocation_config80", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("Opp_Allocation_config80", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("Opp_Allocation_config80", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("Opp_Allocation_config80", "ToBeAssigned", rowNum);
		...
		TeamPage teamobj = PageFactory.initElements(driver, TeamPage.class);
		String OppName = reader.getCellData("Opp_Allocation_config80", "Opportunity Name", rowCount);
