...
public class Opp_Allocation_config85 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/opportunityCreation85.html");
	...
	@Test
	public void OpportunityCreation_config85() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Opp_Allocation_config85");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("Opp_Allocation_config85", "Amount", rowNum);
				String Closedate = reader.getCellData("Opp_Allocation_config85", "Close date", rowNum);
				String Stages = reader.getCellData("Opp_Allocation_config85", "Stages", rowNum);
				String OpportunityName = reader.getCellData("Opp_Allocation_config85", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("Opp_Allocation_config85", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("Opp_Allocation_config85", "Ratingtype", rowNum);
				//String RRD_Type = reader.getCellData("Opp_Allocation_config85", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("Opp_Allocation_config85", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("Opp_Allocation_config85", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("Opp_Allocation_config85", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("Opp_Allocation_config85", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("Opp_Allocation_config85", "ToBeAssigned", rowNum);
		...
		TeamPage teamobj = PageFactory.initElements(driver, TeamPage.class);
		String OppName = reader.getCellData("Opp_Allocation_config85", "Opportunity Name", rowCount);
