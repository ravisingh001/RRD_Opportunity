...
public class Opp_Allocation_config81 {
	...
	@Test
	public void OpportunityCreation_config81() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Opp_Allocation_config81");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("Opp_Allocation_config81", "Amount", rowNum);
				String Closedate = reader.getCellData("Opp_Allocation_config81", "Close date", rowNum);
				String Stages = reader.getCellData("Opp_Allocation_config81", "Stages", rowNum);
				String OpportunityName = reader.getCellData("Opp_Allocation_config81", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("Opp_Allocation_config81", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("Opp_Allocation_config81", "Ratingtype", rowNum);
				//String RRD_Type = reader.getCellData("Opp_Allocation_config81", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("Opp_Allocation_config81", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("Opp_Allocation_config81", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("Opp_Allocation_config81", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("Opp_Allocation_config81", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("Opp_Allocation_config81", "ToBeAssigned", rowNum);
		...
		TeamPage teamobj = PageFactory.initElements(driver, TeamPage.class);
		String OppName = reader.getCellData("Opp_Allocation_config81", "Opportunity Name", rowCount);
