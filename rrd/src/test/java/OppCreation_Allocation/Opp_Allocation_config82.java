...
public class Opp_Allocation_config82 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/opportunityCreation82.html");
	...
	@Test
	public void OpportunityCreation_config82() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Opp_Allocation_config82");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("Opp_Allocation_config82", "Amount", rowNum);
				String Closedate = reader.getCellData("Opp_Allocation_config82", "Close date", rowNum);
				String Stages = reader.getCellData("Opp_Allocation_config82", "Stages", rowNum);
				String OpportunityName = reader.getCellData("Opp_Allocation_config82", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("Opp_Allocation_config82", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("Opp_Allocation_config82", "Ratingtype", rowNum);
				// String RRD_Type = reader.getCellData("Opp_Allocation_config82", "RRD_Type",
				// rowNum);
				String RRD_LeadSource = reader.getCellData("Opp_Allocation_config82", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("Opp_Allocation_config82", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("Opp_Allocation_config82", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("Opp_Allocation_config82", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("Opp_Allocation_config82", "ToBeAssigned", rowNum);
		...
		TeamPage teamobj = PageFactory.initElements(driver, TeamPage.class);
		String OppName = reader.getCellData("Opp_Allocation_config82", "Opportunity Name", rowCount);
		String ChangedOwner = reader.getCellData("ChangeOwner", "Changed Owner", rowCount);
		...
		teamobj.clickonChangeOwner_IntegrationUser();
