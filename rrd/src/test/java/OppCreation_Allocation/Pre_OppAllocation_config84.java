...
public class Pre_OppAllocation_config84 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/opportunityCreation_Dummy84.html");
	...
	public void OpportunityCreation_config84() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("DummyTest_Config84");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("DummyTest_Config84", "Amount", rowNum);
				String Closedate = reader.getCellData("DummyTest_Config84", "Close date", rowNum);
				String Stages = reader.getCellData("DummyTest_Config84", "Stages", rowNum);
				String OpportunityName = reader.getCellData("DummyTest_Config84", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("DummyTest_Config84", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("DummyTest_Config84", "Ratingtype", rowNum);
				//String RRD_Type = reader.getCellData("DummyTest_Config84", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("DummyTest_Config84", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("DummyTest_Config84", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("DummyTest_Config84", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("DummyTest_Config84", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("DummyTest_Config84", "ToBeAssigned", rowNum);
		...
		TeamPage teamobj = PageFactory.initElements(driver, TeamPage.class);
		String OppName = reader.getCellData("DummyTest_Config84", "Opportunity Name", rowCount);
