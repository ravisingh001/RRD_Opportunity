...
public class Opp_Allocation_config7 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/opportunityCreation7.html");
	...
	@Test
	public void OpportunityCreation_config7() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Opp_Allocation_config7_1");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("Opp_Allocation_config7_1", "Amount", rowNum);
				String Closedate = reader.getCellData("Opp_Allocation_config7_1", "Close date", rowNum);
				String Stages = reader.getCellData("Opp_Allocation_config7_1", "Stages", rowNum);
				String OpportunityName = reader.getCellData("Opp_Allocation_config7_1", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("Opp_Allocation_config7_1", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("Opp_Allocation_config7_1", "Ratingtype", rowNum);
				...
				String Discription = reader.getCellData("Opp_Allocation_config7_1", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("Opp_Allocation_config7_1", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("Opp_Allocation_config7_1", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("Opp_Allocation_config7_1", "ToBeAssigned", rowNum);
				...
				/*
				 * caseobj.pickfromOpp_Type(RRD_Type); logger.log(LogStatus.INFO,
				 * "Successfully picked from type ");
				 * 
				 * caseobj.pickfromOpp_LeadSource(RRD_LeadSource); logger.log(LogStatus.INFO,
		...
		int rowcount = reader.getRowCount("Opp_Allocation_config7_2");
		for (int rownum = 2; rownum <= rowcount; rownum++) {

			try {
				String Amount = reader.getCellData("Opp_Allocation_config7_2", "Amount", rownum);
				String Closedate = reader.getCellData("Opp_Allocation_config7_2", "Close date", rownum);
				String Stages = reader.getCellData("Opp_Allocation_config7_2", "Stages", rownum);
				String OpportunityName = reader.getCellData("Opp_Allocation_config7_2", "Opportunity Name", rownum);
				String AccountName = reader.getCellData("Opp_Allocation_config7_2", "Account Name", rownum);
				String Ratingtype = reader.getCellData("Opp_Allocation_config7_2", "Ratingtype", rownum);
				/*
				 ...
				 */
				String Discription = reader.getCellData("Opp_Allocation_config7_2", "Discription", rownum);
				String ExpectedResult = reader.getCellData("Opp_Allocation_config7_2", "ExpectedResult", rownum);
