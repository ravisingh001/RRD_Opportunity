...
public class Opp_Allocation_config4 {
	WebDriver driver;
	...
	@Test
	public void OpportunityCreation_config4() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Opp_Allocation_config4");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("Opp_Allocation_config4", "Amount", rowNum);
				String Closedate = reader.getCellData("Opp_Allocation_config4", "Close date", rowNum);
				String Stages = reader.getCellData("Opp_Allocation_config4", "Stages", rowNum);
				String OpportunityName = reader.getCellData("Opp_Allocation_config4", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("Opp_Allocation_config4", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("Opp_Allocation_config4", "Ratingtype", rowNum);
				String RRD_Type = reader.getCellData("Opp_Allocation_config4", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("Opp_Allocation_config4", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("Opp_Allocation_config4", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("Opp_Allocation_config4", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("Opp_Allocation_config4", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("Opp_Allocation_config4", "ToBeAssigned", rowNum);
