...
public class Opp_Allocation_config3 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/opportunityCreation3.html");
		logger = report.startTest("Verify opportunity Creation 3");
	...
	@Test
	public void OpportunityCreation_config5() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Opp_Allocation_config3");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("Opp_Allocation_config3", "Amount", rowNum);
				String Closedate = reader.getCellData("Opp_Allocation_config3", "Close date", rowNum);
				String Stages = reader.getCellData("Opp_Allocation_config3", "Stages", rowNum);
				String OpportunityName = reader.getCellData("Opp_Allocation_config3", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("Opp_Allocation_config3", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("Opp_Allocation_config3", "Ratingtype", rowNum);
				String RRD_Type = reader.getCellData("Opp_Allocation_config3", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("Opp_Allocation_config3", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("Opp_Allocation_config3", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("Opp_Allocation_config3", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("Opp_Allocation_config3", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("Opp_Allocation_config3", "ToBeAssigned", rowNum);
		...
		int rowcount = reader.getRowCount("Opp_Allocation_config3_1");
		for (int rownum = 2; rownum <= rowcount; rownum++) {

			try {
				String Amount = reader.getCellData("Opp_Allocation_config3_1", "Amount", rownum);
				String Closedate = reader.getCellData("Opp_Allocation_config3_1", "Close date", rownum);
				String Stages = reader.getCellData("Opp_Allocation_config3_1", "Stages", rownum);
				String OpportunityName = reader.getCellData("Opp_Allocation_config3_1", "Opportunity Name", rownum);
				String AccountName = reader.getCellData("Opp_Allocation_config3_1", "Account Name", rownum);
				String Ratingtype = reader.getCellData("Opp_Allocation_config3_1", "Ratingtype", rownum);
				String RRD_Type = reader.getCellData("Opp_Allocation_config3_1", "RRD_Type", rownum);
				String RRD_LeadSource = reader.getCellData("Opp_Allocation_config3_1", "RRD_LeadSource", rownum);
				String Discription = reader.getCellData("Opp_Allocation_config3_1", "Discription", rownum);
				String ExpectedResult = reader.getCellData("Opp_Allocation_config3_1", "ExpectedResult", rownum);
