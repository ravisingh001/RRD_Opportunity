...
public class Opp_Allocation_config84 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/opportunityCreation84.html");
	...
	public void OpportunityCreation_config84() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Opp_Allocation_config84");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("Opp_Allocation_config84", "Amount", rowNum);
				String Closedate = reader.getCellData("Opp_Allocation_config84", "Close date", rowNum);
				String Stages = reader.getCellData("Opp_Allocation_config84", "Stages", rowNum);
				String OpportunityName = reader.getCellData("Opp_Allocation_config84", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("Opp_Allocation_config84", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("Opp_Allocation_config84", "Ratingtype", rowNum);
				//String RRD_Type = reader.getCellData("Opp_Allocation_config84", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("Opp_Allocation_config84", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("Opp_Allocation_config84", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("Opp_Allocation_config84", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("Opp_Allocation_config84", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("Opp_Allocation_config84", "ToBeAssigned", rowNum);
		...
		TeamPage teamobj = PageFactory.initElements(driver, TeamPage.class);
		String OppName = reader.getCellData("Opp_Allocation_config84", "Opportunity Name", rowCount);
