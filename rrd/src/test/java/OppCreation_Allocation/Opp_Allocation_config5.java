...
public class Opp_Allocation_config5 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/opportunityCreation5.html");
	...
	public void OpportunityCreation_config5() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Opp_Allocation_config5");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("Opp_Allocation_config5", "Amount", rowNum);
				String Closedate = reader.getCellData("Opp_Allocation_config5", "Close date", rowNum);
				String Stages = reader.getCellData("Opp_Allocation_config5", "Stages", rowNum);
				String OpportunityName = reader.getCellData("Opp_Allocation_config5", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("Opp_Allocation_config5", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("Opp_Allocation_config5", "Ratingtype", rowNum);
				//String RRD_Type = reader.getCellData("Opp_Allocation_config5", "RRD_Type", rowNum);
				//String RRD_LeadSource = reader.getCellData("Opp_Allocation_config5", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("Opp_Allocation_config5", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("Opp_Allocation_config5", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("Opp_Allocation_config5", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("Opp_Allocation_config5", "ToBeAssigned", rowNum);
