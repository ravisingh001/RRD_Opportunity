...
public class Lead_Config3 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Lead_Configurationscenario.html");
		logger = report.startTest("Verify Lead Configuration scenario");
	...
	public void Test_Config3() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Lead_Config3");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			String sUser1 = reader.getCellData("Lead_Config3", "Enable_RRD_Users", rowNum);
			String sOwnerNotification = reader.getCellData("Lead_Config3", "ownerNotification", rowNum);
			String sReleationshipBasedAssignment = reader.getCellData("Lead_Config3", "Rel_Based_Asgmt", rowNum);
