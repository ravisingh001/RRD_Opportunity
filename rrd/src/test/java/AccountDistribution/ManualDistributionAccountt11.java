package AccountDistribution;
	...
	public class ManualDistributionAccountt11 {
		...
		public void AccountManualDistribution11() throws InterruptedException {
			 ...
			 * manualdistribution.clickonDistributeAccount(); logger.log(LogStatus.INFO,
			 * "Clicked on Distribute Account button to distribute the Account successfully"
			 * );
			 * 
			...
			for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
				...
				String Result = reader.getCellData("AccountAllocation11", "ExpectedResultAfterDistribution", rowNum);
