...
public class ContactConfig4 {
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Contact Configuration 4</b>
	 * </p>
	 * <p>
	 ...
	 * 
	 * <p>
	 * 6.Select user from drop down value that is All.
	 * </p>
	 * <p>
	 * 7.Select owner notification from drop down value that is by Notify by Email.
	 * </p>
	 * <p>
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/ContactConfiguration4.html");
		logger = report.startTest("Verify Contact Configuration4");
	...
	@Test
	public void TestContactConfig4() throws InterruptedException {

		Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);

		int rowCount = reader.getRowCount("Contactconfig4");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			String sUser1 = reader.getCellData("Contactconfig4", "Enable_RRD_Users", rowNum);
			String sOwnerNotification = reader.getCellData("Contactconfig4", "ownerNotification", rowNum);
			String sDefaultowner = reader.getCellData("Contactconfig4", "DefaultOwner", rowNum);
