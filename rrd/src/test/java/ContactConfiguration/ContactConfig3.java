...
public class ContactConfig3 {
	
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Contact Configuration 3</b>
	 * </p>
	 * <p>
	 ...
	 * <p>10.Assert that Contact config  changes has saved By checking if Edit button is visible or not </p>
	 * 
	 * 
	 * 
	 * @author Ravi
	 ...
	 */
			...
			ExtentTest logger;
			Properties pro;
			public String Testdata_sheet_path=System.getProperty("user.dir") +File.separator+"AppData"+File.separator+"ContactConfigData.xlsx";
			
			@BeforeMethod
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/ContactConfiguration3.html");
				logger = report.startTest("Verify Contact Configuration3");
			...
			@Test
			public void TestContactConfig3() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Contactconfig3");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Contactconfig3", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Contactconfig3", "ownerNotification", rowNum);
				String sDefaultowner=reader.getCellData("Contactconfig3", "DefaultOwner", rowNum);
				...
				step1AccConfigPage.clickOnContact();
				...
				try
				{
				Assert.assertTrue(step1AccConfigPage.isEditButtonVisible(), "Contact Configuration data was  not submitted successfully");
				}
				catch(Exception e)
				{
