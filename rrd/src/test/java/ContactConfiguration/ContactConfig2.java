...
public class ContactConfig2 {
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Contact Configuration 2</b>
	 * </p>
	 * <p>
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/ContactConfiguration2.html");
		logger = report.startTest("Verify Contact Configuration2");
	...
	@Test
	public void TestContactConfig2() throws InterruptedException {

		Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);

		int rowCount = reader.getRowCount("Contactconfig2");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			String sUser1 = reader.getCellData("Contactconfig2", "Enable_RRD_Users", rowNum);
			String sOwnerNotification = reader.getCellData("Contactconfig2", "ownerNotification", rowNum);
			String sDefaultowner = reader.getCellData("Contactconfig2", "DefaultOwner", rowNum);
