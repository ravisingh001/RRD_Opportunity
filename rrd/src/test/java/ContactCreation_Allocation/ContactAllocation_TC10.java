...
public class ContactAllocation_TC10 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/ContactCreation10.html");
		logger = report.startTest("Verify Contact Creation 10");
	...
	@Test
	public void ContactCreation_config10() throws InterruptedException {
		...
		int RowCount = reader.getRowCount("ContactAllocation10_1");
		for (int rowNum = 2; rowNum <= RowCount; rowNum++) {
			String Solutation = reader.getCellData("ContactAllocation10_1", "Salutation", rowNum);
			String LastName = reader.getCellData("ContactAllocation10_1", "LastName", rowNum);
			String AccountName = reader.getCellData("ContactAllocation10_1", "AccountName", rowNum);
			String Result = reader.getCellData("ContactAllocation10_1", "ExpectedResult", rowNum);
			String Teamname = reader.getCellData("ContactAllocation10_1", "TeamName", rowNum);
			String ToBeAssigned = reader.getCellData("ContactAllocation10_1", "ToBeAssigned", rowNum);
			...
			Contactobj.pick_Solutation(Solutation);
			logger.log(LogStatus.INFO, "Pick Solutation");
		...
		int rowCount = reader.getRowCount("ContactAllocation10_2");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			
			String Solutation = reader.getCellData("ContactAllocation10_2", "Salutation", rowNum);
			String LastName = reader.getCellData("ContactAllocation10_2", "LastName", rowNum);
			String AccountName = reader.getCellData("ContactAllocation10_2", "AccountName", rowNum);
			String Result = reader.getCellData("ContactAllocation10_2", "ExpectedResult", rowNum);
			String Teamname = reader.getCellData("ContactAllocation10_2", "TeamName", rowNum);
			String ToBeAssigned = reader.getCellData("ContactAllocation10_2", "ToBeAssigned", rowNum);
		...
		String DC = reader.getCellData("ContactAllocation10_2", "Distribution Count", rowNum);
		...
		try {
			...
			softassert.assertTrue(Username.equalsIgnoreCase(DC),"Contact Distribution Count is matching");
		}
		catch (Exception e)
		{
			System.out.println("Contact Distribution Count from sheet - " + DC);
