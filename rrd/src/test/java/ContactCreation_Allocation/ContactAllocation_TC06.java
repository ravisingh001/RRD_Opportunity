...
public class ContactAllocation_TC06 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/ContactCreation6.html");
		logger = report.startTest("Verify Contact Creation 6");
	...
	@Test
	public void ContactCreation_config06() throws InterruptedException {
		...
		int RowCount = reader.getRowCount("ContactAllocation6_1");
...
//			logger.log(LogStatus.INFO, "Successfully clicked on save");
		...
		int rowCount = reader.getRowCount("ContactAllocation6_2");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
