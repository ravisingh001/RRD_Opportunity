...
public class ContactAllocation_TC02 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/ContactCreation2.html");
	...
	@Test
	public void ContactCreation_config2() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("ContactAllocation2_1");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			String LastName = reader.getCellData("ContactAllocation2_1", "LastName", rowNum);
			String AccountName = reader.getCellData("ContactAllocation2_1", "AccountName", rowNum);
			String departmentname = reader.getCellData("ContactAllocation2_1", "Department", rowNum);
			String Result = reader.getCellData("ContactAllocation2_1", "ExpectedResult", rowNum);
			String Teamname = reader.getCellData("ContactAllocation2_1", "TeamName", rowNum);
			String ToBeAssigned = reader.getCellData("ContactAllocation2_1", "ToBeAssigned", rowNum);
		...
		int RowCount = reader.getRowCount("ContactAllocation2_2");
		for (int rowNum = 2; rowNum <= RowCount; rowNum++) {
			String LastName = reader.getCellData("ContactAllocation2_2", "LastName", rowNum);
			String AccountName = reader.getCellData("ContactAllocation2_2", "AccountName", rowNum);
			String departmentname = reader.getCellData("ContactAllocation2_2", "Department", rowNum);
			String Result = reader.getCellData("ContactAllocation2_2", "ExpectedResult", rowNum);
			String Teamname = reader.getCellData("ContactAllocation2_2", "TeamName", rowNum);
			String ToBeAssigned = reader.getCellData("ContactAllocation2_2", "ToBeAssigned", rowNum);
