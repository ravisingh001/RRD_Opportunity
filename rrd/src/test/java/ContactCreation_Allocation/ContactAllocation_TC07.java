...
public class ContactAllocation_TC07 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/ContactCreation7.html");
		logger = report.startTest("Verify Contact Creation 7");
	...
	@Test
	public void ContactCreation_config07() throws InterruptedException {
		...
		int RowCount = reader.getRowCount("ContactAllocation7_1");
		for (int rowNum = 2; rowNum <= RowCount; rowNum++) {
			String FirstName = reader.getCellData("ContactAllocation7_1", "FirstName", rowNum);
			String LastName = reader.getCellData("ContactAllocation7_1", "LastName", rowNum);
			String Leadsource = reader.getCellData("ContactAllocation7_1", "Lead Source", rowNum);
			String AccountName = reader.getCellData("ContactAllocation7_1", "AccountName", rowNum);
			String Result = reader.getCellData("ContactAllocation7_1", "ExpectedResult", rowNum);
			String Teamname = reader.getCellData("ContactAllocation7_1", "TeamName", rowNum);
			String ToBeAssigned = reader.getCellData("ContactAllocation7_1", "ToBeAssigned", rowNum);
		...
		int rowCount = reader.getRowCount("ContactAllocation7_2");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			String FirstName = reader.getCellData("ContactAllocation7_2", "FirstName", rowNum);
			String LastName = reader.getCellData("ContactAllocation7_2", "LastName", rowNum);
			String Leadsource = reader.getCellData("ContactAllocation7_2", "Lead Source", rowNum);
			String AccountName = reader.getCellData("ContactAllocation7_2", "AccountName", rowNum);
			String Result = reader.getCellData("ContactAllocation7_2", "ExpectedResult", rowNum);
			String Teamname = reader.getCellData("ContactAllocation7_2", "TeamName", rowNum);
			String ToBeAssigned = reader.getCellData("ContactAllocation7_2", "ToBeAssigned", rowNum);
