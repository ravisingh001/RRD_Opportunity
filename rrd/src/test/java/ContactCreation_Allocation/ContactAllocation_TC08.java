...
public class ContactAllocation_TC08 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/ContactCreation8.html");
		logger = report.startTest("Verify Contact Creation 8");
	...
	@Test
	public void ContactCreation_config08() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("ContactAllocation8");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			String LastName = reader.getCellData("ContactAllocation8", "LastName", rowNum);
			String AccountName = reader.getCellData("ContactAllocation8", "AccountName", rowNum);
			String Title = reader.getCellData("ContactAllocation8", "Title", rowNum);
			String Result = reader.getCellData("ContactAllocation8", "ExpectedResult", rowNum);
			String Teamname = reader.getCellData("ContactAllocation8", "TeamName", rowNum);
			String ToBeAssigned = reader.getCellData("ContactAllocation8", "ToBeAssigned", rowNum);
			...
			try {
				...
				System.out.println("User is Assigned to default owner as RRD user is offline");
				System.out.printf("%n");
			}
