...
public class ContactAllocation_TC09 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/ContactCreation9.html");
		logger = report.startTest("Verify Contact Creation 9");
	...
	@Test
	public void ContactCreation_config09() throws InterruptedException {
		...
		for (int rowNum = 2; rowNum <= RowCount; rowNum++) {
			...
			String Leadsource = reader.getCellData("ContactAllocation9_1", "Lead Source", rowNum);
			String Result = reader.getCellData("ContactAllocation9_1", "ExpectedResult", rowNum);
			String Teamname = reader.getCellData("ContactAllocation9_1", "TeamName", rowNum);
			String ToBeAssigned = reader.getCellData("ContactAllocation9_1", "ToBeAssigned", rowNum);
		...
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			...
			String Result = reader.getCellData("ContactAllocation9_2", "ExpectedResult", rowNum);
			String Leadsource = reader.getCellData("ContactAllocation9_2", "Lead Source", rowNum);
			String Teamname = reader.getCellData("ContactAllocation9_2", "TeamName", rowNum);
			String ToBeAssigned = reader.getCellData("ContactAllocation9_2", "ToBeAssigned", rowNum);
