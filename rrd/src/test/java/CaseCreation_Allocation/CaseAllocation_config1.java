...
public class CaseAllocation_config1 {
	...
	public void CaseCreation_config1() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("CaseAllocation_config1_1");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			String Status = reader.getCellData("CaseAllocation_config1_1", "Status", rowNum);
			String Priority = reader.getCellData("CaseAllocation_config1_1", "Priority", rowNum);
			String CaseOrigin = reader.getCellData("CaseAllocation_config1_1", "CaseOrigin", rowNum);
			String saluationtest = reader.getCellData("CaseAllocation_config1_1", "Salutation", rowNum);
			String firstname = reader.getCellData("CaseAllocation_config1_1", "Firstname", rowNum);
			String lastName = reader.getCellData("CaseAllocation_config1_1", "LastName", rowNum);
			String Account = reader.getCellData("CaseAllocation_config1_1", "Account", rowNum);
			String Ratingval = reader.getCellData("CaseAllocation_config1_1", "Ratingtype", rowNum);
			String RRDType = reader.getCellData("CaseAllocation_config1_1", "RRDType", rowNum);
			String RRDCaseReason = reader.getCellData("CaseAllocation_config1_1", "RRDCaseReason", rowNum);
			String WebEmailtext = reader.getCellData("CaseAllocation_config1_1", "WebEmailtext", rowNum);
			String Subject = reader.getCellData("CaseAllocation_config1_1", "Subject", rowNum);
			String Description = reader.getCellData("CaseAllocation_config1_1", "Description", rowNum);
			String Internalcommnet = reader.getCellData("CaseAllocation_config1_1", "Internal comment", rowNum);
			String Assigneduser = reader.getCellData("CaseAllocation_config1_1", "ExpectedResult", rowNum);
			String Teamname = reader.getCellData("CaseAllocation_config1_1", "TeamName", rowNum);
			String ToBecount = reader.getCellData("CaseAllocation_config1_1", "ToBeAssigned", rowNum);
			...
			logger.log(LogStatus.INFO, "Successfully enter lastname");
		...
		int RowCount = Reader.getRowCount("CaseAllocation_config1_2");
		for (int rowNum = 2; rowNum <= RowCount; rowNum++) {
			String Status = Reader.getCellData("CaseAllocation_config1_2", "Status", rowNum);
			String Priority = Reader.getCellData("CaseAllocation_config1_2", "Priority", rowNum);
			String CaseOrigin = Reader.getCellData("CaseAllocation_config1_2", "CaseOrigin", rowNum);
			String saluationtest = Reader.getCellData("CaseAllocation_config1_2", "Salutation", rowNum);
			String firstname = Reader.getCellData("CaseAllocation_config1_2", "Firstname", rowNum);
			String lastName = Reader.getCellData("CaseAllocation_config1_2", "LastName", rowNum);
			String Account = Reader.getCellData("CaseAllocation_config1_2", "Account", rowNum);
			String Ratingval = Reader.getCellData("CaseAllocation_config1_2", "Ratingtype", rowNum);
			String RRDType = Reader.getCellData("CaseAllocation_config1_2", "RRDType", rowNum);
			String RRDCaseReason = Reader.getCellData("CaseAllocation_config1_2", "RRDCaseReason", rowNum);
			String WebEmailtext = Reader.getCellData("CaseAllocation_config1_2", "WebEmailtext", rowNum);
			String Subject = Reader.getCellData("CaseAllocation_config1_2", "Subject", rowNum);
			String Description = Reader.getCellData("CaseAllocation_config1_2", "Description", rowNum);
			String Internalcommnet = Reader.getCellData("CaseAllocation_config1_2", "Internal comment", rowNum);
			String Assigneduser = Reader.getCellData("CaseAllocation_config1_2", "ExpectedResult", rowNum);
			String Teamname = Reader.getCellData("CaseAllocation_config1_2", "TeamName", rowNum);
			String ToBecount = Reader.getCellData("CaseAllocation_config1_2", "ToBeAssigned", rowNum);
