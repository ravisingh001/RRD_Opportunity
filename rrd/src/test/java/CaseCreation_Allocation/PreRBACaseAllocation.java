...
public class PreRBACaseAllocation {
	...
	public void PreRBAcaseAllocation() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("PreRBACaseAllocation1_1");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			String Status = reader.getCellData("PreRBACaseAllocation1_1", "Status", rowNum);
			String Priority = reader.getCellData("PreRBACaseAllocation1_1", "Priority", rowNum);
			String CaseOrigin = reader.getCellData("PreRBACaseAllocation1_1", "CaseOrigin", rowNum);
			String saluationtest = reader.getCellData("PreRBACaseAllocation1_1", "Salutation", rowNum);
			String firstname = reader.getCellData("PreRBACaseAllocation1_1", "Firstname", rowNum);
			String lastName = reader.getCellData("PreRBACaseAllocation1_1", "LastName", rowNum);
			String Account = reader.getCellData("PreRBACaseAllocation1_1", "Account", rowNum);
			String Ratingval = reader.getCellData("PreRBACaseAllocation1_1", "Ratingtype", rowNum);
			String RRDType = reader.getCellData("PreRBACaseAllocation1_1", "RRDType", rowNum);
			String RRDCaseReason = reader.getCellData("PreRBACaseAllocation1_1", "RRDCaseReason", rowNum);
			String WebEmailtext = reader.getCellData("PreRBACaseAllocation1_1", "WebEmailtext", rowNum);
			String Subject = reader.getCellData("PreRBACaseAllocation1_1", "Subject", rowNum);
			String Description = reader.getCellData("PreRBACaseAllocation1_1", "Description", rowNum);
			String Internalcommnet = reader.getCellData("PreRBACaseAllocation1_1", "Internal comment", rowNum);
			String Assigneduser = reader.getCellData("PreRBACaseAllocation1_1", "ExpectedResult", rowNum);
			String Teamname = reader.getCellData("PreRBACaseAllocation1_1", "TeamName", rowNum);
			String ToBecount = reader.getCellData("PreRBACaseAllocation1_1", "ToBeAssigned", rowNum);
		...
		int RowCount = Reader.getRowCount("PreRBACaseAllocation1_2");
		for (int rowNum = 2; rowNum <= RowCount; rowNum++) {
			String Status = Reader.getCellData("PreRBACaseAllocation1_2", "Status", rowNum);
			String Priority = Reader.getCellData("PreRBACaseAllocation1_2", "Priority", rowNum);
			String CaseOrigin = Reader.getCellData("PreRBACaseAllocation1_2", "CaseOrigin", rowNum);
			String saluationtest = Reader.getCellData("PreRBACaseAllocation1_2", "Salutation", rowNum);
			String firstname = Reader.getCellData("PreRBACaseAllocation1_2", "Firstname", rowNum);
			String lastName = Reader.getCellData("PreRBACaseAllocation1_2", "LastName", rowNum);
			String Account = Reader.getCellData("PreRBACaseAllocation1_2", "Account", rowNum);
			String Ratingval = Reader.getCellData("PreRBACaseAllocation1_2", "Ratingtype", rowNum);
			String RRDType = Reader.getCellData("PreRBACaseAllocation1_2", "RRDType", rowNum);
			String RRDCaseReason = Reader.getCellData("PreRBACaseAllocation1_2", "RRDCaseReason", rowNum);
			String WebEmailtext = Reader.getCellData("PreRBACaseAllocation1_2", "WebEmailtext", rowNum);
			String Subject = Reader.getCellData("PreRBACaseAllocation1_2", "Subject", rowNum);
			String Description = Reader.getCellData("PreRBACaseAllocation1_2", "Description", rowNum);
			String Internalcommnet = Reader.getCellData("PreRBACaseAllocation1_2", "Internal comment", rowNum);
			String Assigneduser = Reader.getCellData("PreRBACaseAllocation1_2", "ExpectedResult", rowNum);
			String Teamname = Reader.getCellData("PreRBACaseAllocation1_2", "TeamName", rowNum);
			String ToBecount = Reader.getCellData("PreRBACaseAllocation1_2", "ToBeAssigned", rowNum);
