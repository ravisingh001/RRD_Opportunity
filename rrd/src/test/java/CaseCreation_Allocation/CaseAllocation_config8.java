...
public class CaseAllocation_config8 {
	...
	public void CaseCreation_config8() throws InterruptedException {
		...
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			...
			// String Assigneduser=reader.getCellData("CaseAllocation_config8",
			// "ExpectedResult", rowNum);
			...
			try {
				...
				if (Assigneduser.contains("RRD Mirketa")) {
					softassert.assertTrue(Username.equalsIgnoreCase("RRD Mirketa"),
							"Assigned RRD user name is not matching");
				} else if (Assigneduser.contains("Testing_Nandini")) {
					softassert.assertTrue(Username.equalsIgnoreCase("Testing_Nandini"),
							"Assigned RRD user name is not matching");
				}
			}
