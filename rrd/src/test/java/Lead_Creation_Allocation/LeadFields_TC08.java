...
public class LeadFields_TC08 {
	...
	public void LeadCreation_LeadFields_TC08() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("LeadFields_TC08");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Phone = reader.getCellData("LeadFields_TC08", "Phone", rowNum);
				String LastName = reader.getCellData("LeadFields_TC08", "Last Name", rowNum);
				String Company = reader.getCellData("LeadFields_TC08", "Company", rowNum);
				String LeadStatus = reader.getCellData("LeadFields_TC08", "Lead Status", rowNum);
				String Country = reader.getCellData("LeadFields_TC08", "Country", rowNum);
				String Discription = reader.getCellData("LeadFields_TC08", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("LeadFields_TC08", "ExpectedResult", rowNum);
				//String TeamName = reader.getCellData("LeadFields_TC08", "TeamName", rowNum);
				//String ToBeAssigned = reader.getCellData("LeadFields_TC08", "ToBeAssigned", rowNum);
