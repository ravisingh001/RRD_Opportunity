...
public class ExistingOpportunity_TC07 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_ExistingOpportunity_TC07.html");
		logger = report.startTest("Verify Lead Creation ExistingOpportunity_TC07");
	...
	@Test
	public void LeadCreation_ExistingOpportunity_TC07() throws InterruptedException {
		...
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			...
			try {
				String Amount = reader.getCellData("ExistingOpportunity_TC07", "Amount", rowNum);
				String Closedate = reader.getCellData("ExistingOpportunity_TC07", "Close date", rowNum);
				String Stages = reader.getCellData("ExistingOpportunity_TC07", "Stages", rowNum);
				String OpportunityName = reader.getCellData("ExistingOpportunity_TC07", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("ExistingOpportunity_TC07", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("ExistingOpportunity_TC07", "Ratingtype", rowNum);
				String RRD_Type = reader.getCellData("ExistingOpportunity_TC07", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("ExistingOpportunity_TC07", "RRD_LeadSource", rowNum);
