...
public class ExistingAccount_TC04 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_ExistingAccount_TC04.html");
		logger = report.startTest("Verify Lead Creation ExistingAccount_TC04");
	...
	@Test
	public void LeadCreation_ExistingAccount_TC04() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("ExistingAccount_TC04");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String AccountName = reader.getCellData("ExistingAccount_TC04", "AccountName", rowNum);
				String Rating = reader.getCellData("ExistingAccount_TC04", "Rating", rowNum);
				String Result = reader.getCellData("ExistingAccount_TC04", "ExpectedResult", rowNum);
		...
		for (int RowNum = 2; RowNum <= RowCount; RowNum++) {
			...
			try {
				String Phone = Reader.getCellData("ExistingAccount_TC04", "Phone", RowNum);
				String FirstName = Reader.getCellData("ExistingAccount_TC04", "First Name", RowNum);
				String LastName = Reader.getCellData("ExistingAccount_TC04", "Last Name", RowNum);
				String Company = Reader.getCellData("ExistingAccount_TC04", "Company", RowNum);
				String LeadStatus = Reader.getCellData("ExistingAccount_TC04", "Lead Status", RowNum);
				String Discription = Reader.getCellData("ExistingAccount_TC04", "Discription", RowNum);
				String ExpectedResult = Reader.getCellData("ExistingAccount_TC04", "ExpectedResult", RowNum);
