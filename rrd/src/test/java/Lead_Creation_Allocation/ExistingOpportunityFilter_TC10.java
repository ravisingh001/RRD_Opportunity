...
public class ExistingOpportunityFilter_TC10 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_ExistingOpportunityFilter_TC10.html");
		logger = report.startTest("Verify Lead Creation ExistingOpportunityFilter_TC10");
	...
	@Test
	public void LeadCreation_ExistingOpportunity_TC10() throws InterruptedException {
		...
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			...
			try {
				String Amount = reader.getCellData("ExistingOpportunityFilter_TC10", "Amount", rowNum);
				String Closedate = reader.getCellData("ExistingOpportunityFilter_TC10", "Close date", rowNum);
				String Stages = reader.getCellData("ExistingOpportunityFilter_TC10", "Stages", rowNum);
				String OpportunityName = reader.getCellData("ExistingOpportunityFilter_TC10", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("ExistingOpportunityFilter_TC10", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("ExistingOpportunityFilter_TC10", "Ratingtype", rowNum);
				String RRD_Type = reader.getCellData("ExistingOpportunityFilter_TC10", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("ExistingOpportunityFilter_TC10", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("ExistingOpportunityFilter_TC10", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("ExistingOpportunityFilter_TC10", "ExpectedResult", rowNum);
		...
		for (int RowNum = 2; RowNum <= RowCount; RowNum++) {
			...
			try {
				String Phone = Reader.getCellData("ExistingOpportunityFilter_TC10", "Phone", RowNum);
				String FirstName = Reader.getCellData("ExistingOpportunityFilter_TC10", "First Name", RowNum);
				String LastName = Reader.getCellData("ExistingOpportunityFilter_TC10", "Last Name", RowNum);
				String Company = Reader.getCellData("ExistingOpportunityFilter_TC10", "Company", RowNum);
				String LeadStatus = Reader.getCellData("ExistingOpportunityFilter_TC10", "Lead Status", RowNum);
				String Discription = Reader.getCellData("ExistingOpportunityFilter_TC10", "Discription", RowNum);
				String ExpectedResult = Reader.getCellData("ExistingOpportunityFilter_TC10", "ExpectedResult", RowNum);
