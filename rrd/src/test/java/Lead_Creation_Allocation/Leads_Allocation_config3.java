...
public class Leads_Allocation_config3 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_Config3.html");
	...
	@Test
	public void LeadCreation_config3() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Lead_Allocation_config3");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Phone = reader.getCellData("Lead_Allocation_config3", "Phone", rowNum);
				String LastName = reader.getCellData("Lead_Allocation_config3", "Last Name", rowNum);
				String Company = reader.getCellData("Lead_Allocation_config3", "Company", rowNum);
				String LeadStatus = reader.getCellData("Lead_Allocation_config3", "Lead Status", rowNum);
				String Country = reader.getCellData("Lead_Allocation_config3", "Country", rowNum);
				String Discription = reader.getCellData("Lead_Allocation_config3", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("Lead_Allocation_config3", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("Lead_Allocation_config3", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("Lead_Allocation_config3", "ToBeAssigned", rowNum);
