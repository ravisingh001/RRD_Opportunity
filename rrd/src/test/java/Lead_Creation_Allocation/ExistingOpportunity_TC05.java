...
public class ExistingOpportunity_TC05 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_ExistingOpportunity_TC05.html");
		logger = report.startTest("Verify Lead Creation ExistingOpportunity_TC05");
	...
	@Test
	public void LeadCreation_ExistingOpportunity_TC05() throws InterruptedException {
		...
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			...
			try {
				String Amount = reader.getCellData("ExistingOpportunity_TC05", "Amount", rowNum);
				String Closedate = reader.getCellData("ExistingOpportunity_TC05", "Close date", rowNum);
				String Stages = reader.getCellData("ExistingOpportunity_TC05", "Stages", rowNum);
				String OpportunityName = reader.getCellData("ExistingOpportunity_TC05", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("ExistingOpportunity_TC05", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("ExistingOpportunity_TC05", "Ratingtype", rowNum);
				String RRD_Type = reader.getCellData("ExistingOpportunity_TC05", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("ExistingOpportunity_TC05", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("ExistingOpportunity_TC05", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("ExistingOpportunity_TC05", "ExpectedResult", rowNum);
		...
		for (int RowNum = 2; RowNum <= RowCount; RowNum++) {
			...
			try {
				String Phone = Reader.getCellData("ExistingOpportunity_TC05", "Phone", RowNum);
				String FirstName = Reader.getCellData("ExistingOpportunity_TC05", "First Name", RowNum);
				String LastName = Reader.getCellData("ExistingOpportunity_TC05", "Last Name", RowNum);
				String Company = Reader.getCellData("ExistingOpportunity_TC05", "Company", RowNum);
				String LeadStatus = Reader.getCellData("ExistingOpportunity_TC05", "Lead Status", RowNum);
				String Discription = Reader.getCellData("ExistingOpportunity_TC05", "Discription", RowNum);
				String ExpectedResult = Reader.getCellData("ExistingOpportunity_TC05", "ExpectedResult", RowNum);
