...
public class ExistingOpportunityFilter_TC15 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_ExistingOpportunityFilter_TC15.html");
		logger = report.startTest("Verify Lead Creation ExistingOpportunityFilter_TC15");
	...
	@Test
	public void LeadCreation_ExistingOpportunity_TC15() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("ExistingOpportunityFilter_TC15");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("ExistingOpportunityFilter_TC15", "Amount", rowNum);
				String Closedate = reader.getCellData("ExistingOpportunityFilter_TC15", "Close date", rowNum);
				String Stages = reader.getCellData("ExistingOpportunityFilter_TC15", "Stages", rowNum);
				String OpportunityName = reader.getCellData("ExistingOpportunityFilter_TC15", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("ExistingOpportunityFilter_TC15", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("ExistingOpportunityFilter_TC15", "Ratingtype", rowNum);
				String RRD_Type = reader.getCellData("ExistingOpportunityFilter_TC15", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("ExistingOpportunityFilter_TC15", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("ExistingOpportunityFilter_TC15", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("ExistingOpportunityFilter_TC15", "ExpectedResult", rowNum);
		...
		for (int RowNum = 2; RowNum <= RowCount; RowNum++) {
			...
			try {
				String Phone = Reader.getCellData("ExistingOpportunityFilter_TC15", "Phone", RowNum);
				String FirstName = Reader.getCellData("ExistingOpportunityFilter_TC15", "First Name", RowNum);
				String LastName = Reader.getCellData("ExistingOpportunityFilter_TC15", "Last Name", RowNum);
				String Company = Reader.getCellData("ExistingOpportunityFilter_TC15", "Company", RowNum);
				String LeadStatus = Reader.getCellData("ExistingOpportunityFilter_TC15", "Lead Status", RowNum);
				String City = Reader.getCellData("ExistingOpportunityFilter_TC15", "City", RowNum);
				String Industry = Reader.getCellData("ExistingOpportunityFilter_TC15", "Industry", RowNum);
				String Discription = Reader.getCellData("ExistingOpportunityFilter_TC15", "Discription", RowNum);
				String ExpectedResult = Reader.getCellData("ExistingOpportunityFilter_TC15", "ExpectedResult", RowNum);
				...
				Leadobj.pickLeadIndustry(Industry);
				logger.log(LogStatus.INFO, "Successfully picked Lead industry");
