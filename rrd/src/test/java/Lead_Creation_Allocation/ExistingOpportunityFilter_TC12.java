...
public class ExistingOpportunityFilter_TC12 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_ExistingOpportunityFilter_TC12.html");
		logger = report.startTest("Verify Lead Creation ExistingOpportunityFilter_TC12");
	...
	@Test
	public void LeadCreation_ExistingOpportunity_TC12() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("ExistingOpportunityFilter_TC12");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("ExistingOpportunityFilter_TC12", "Amount", rowNum);
				String Closedate = reader.getCellData("ExistingOpportunityFilter_TC12", "Close date", rowNum);
				String Stages = reader.getCellData("ExistingOpportunityFilter_TC12", "Stages", rowNum);
				String OpportunityName = reader.getCellData("ExistingOpportunityFilter_TC12", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("ExistingOpportunityFilter_TC12", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("ExistingOpportunityFilter_TC12", "Ratingtype", rowNum);
				String RRD_Type = reader.getCellData("ExistingOpportunityFilter_TC12", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("ExistingOpportunityFilter_TC12", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("ExistingOpportunityFilter_TC12", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("ExistingOpportunityFilter_TC12", "ExpectedResult", rowNum);
		...
		for (int RowNum = 2; RowNum <= RowCount; RowNum++) {
			...
			try {
				String Phone = Reader.getCellData("ExistingOpportunityFilter_TC12", "Phone", RowNum);
				String FirstName = Reader.getCellData("ExistingOpportunityFilter_TC12", "First Name", RowNum);
				String LastName = Reader.getCellData("ExistingOpportunityFilter_TC12", "Last Name", RowNum);
				String Company = Reader.getCellData("ExistingOpportunityFilter_TC12", "Company", RowNum);
				String Employee = Reader.getCellData("ExistingOpportunityFilter_TC12", "No. of Employees", RowNum);
				String LeadStatus = Reader.getCellData("ExistingOpportunityFilter_TC12", "Lead Status", RowNum);
				String City = Reader.getCellData("ExistingOpportunityFilter_TC12", "City", RowNum);
				String Discription = Reader.getCellData("ExistingOpportunityFilter_TC12", "Discription", RowNum);
				String ExpectedResult = Reader.getCellData("ExistingOpportunityFilter_TC12", "ExpectedResult", RowNum);
