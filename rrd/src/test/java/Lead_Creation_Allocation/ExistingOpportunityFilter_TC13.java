...
public class ExistingOpportunityFilter_TC13 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_ExistingOpportunityFilter_TC13.html");
		logger = report.startTest("Verify Lead Creation ExistingOpportunityFilter_TC13");
	...
	@Test
	public void LeadCreation_ExistingOpportunity_TC13() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("ExistingOpportunityFilter_TC13");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Amount = reader.getCellData("ExistingOpportunityFilter_TC13", "Amount", rowNum);
				String Closedate = reader.getCellData("ExistingOpportunityFilter_TC13", "Close date", rowNum);
				String Stages = reader.getCellData("ExistingOpportunityFilter_TC13", "Stages", rowNum);
				String OpportunityName = reader.getCellData("ExistingOpportunityFilter_TC13", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("ExistingOpportunityFilter_TC13", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("ExistingOpportunityFilter_TC13", "Ratingtype", rowNum);
				String RRD_Type = reader.getCellData("ExistingOpportunityFilter_TC13", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("ExistingOpportunityFilter_TC13", "RRD_LeadSource", rowNum);
				String Discription = reader.getCellData("ExistingOpportunityFilter_TC13", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("ExistingOpportunityFilter_TC13", "ExpectedResult", rowNum);
		...
		for (int RowNum = 2; RowNum <= RowCount; RowNum++) {
			...
			try {
				String Phone = Reader.getCellData("ExistingOpportunityFilter_TC13", "Phone", RowNum);
				String FirstName = Reader.getCellData("ExistingOpportunityFilter_TC13", "First Name", RowNum);
				String LastName = Reader.getCellData("ExistingOpportunityFilter_TC13", "Last Name", RowNum);
				String Company = Reader.getCellData("ExistingOpportunityFilter_TC13", "Company", RowNum);
				String Rating = Reader.getCellData("ExistingOpportunityFilter_TC13", "Rating", RowNum);
				String LeadStatus = Reader.getCellData("ExistingOpportunityFilter_TC13", "Lead Status", RowNum);
				String Discription = Reader.getCellData("ExistingOpportunityFilter_TC13", "Discription", RowNum);
				String ExpectedResult = Reader.getCellData("ExistingOpportunityFilter_TC13", "ExpectedResult", RowNum);
