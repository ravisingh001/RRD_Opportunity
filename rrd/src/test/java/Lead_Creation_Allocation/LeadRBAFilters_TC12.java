...
public class LeadRBAFilters_TC12 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_LeadRBAFilters_TC12.html");
		logger = report.startTest("Verify Lead Creation LeadRBAFilters_TC12");
	...
	@Test
	public void LeadCreation_LeadRBAFilter_TC12() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("LeadRBAFilters_TC12_1");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Phone = reader.getCellData("LeadRBAFilters_TC12_1", "Phone", rowNum);
				String LastName = reader.getCellData("LeadRBAFilters_TC12_1", "Last Name", rowNum);
				String Company = reader.getCellData("LeadRBAFilters_TC12_1", "Company", rowNum);
				String LeadStatus = reader.getCellData("LeadRBAFilters_TC12_1", "Lead Status", rowNum);
				String Employee = reader.getCellData("LeadRBAFilters_TC12_1", "No. of Employees", rowNum);
				String Country = reader.getCellData("LeadRBAFilters_TC12_1", "Country", rowNum);
				String Discription = reader.getCellData("LeadRBAFilters_TC12_1", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("LeadRBAFilters_TC12_1", "ExpectedResult", rowNum);
		...
		int RowCount = reader.getRowCount("LeadRBAFilters_TC12_2");
		for (int rowNum = 2; rowNum <= RowCount; rowNum++) {

			try {
				String Phone = reader.getCellData("LeadRBAFilters_TC12_2", "Phone", rowNum);
				String LastName = reader.getCellData("LeadRBAFilters_TC12_2", "Last Name", rowNum);
				String Company = reader.getCellData("LeadRBAFilters_TC12_2", "Company", rowNum);
				String LeadStatus = reader.getCellData("LeadRBAFilters_TC12_2", "Lead Status", rowNum);
				String Employee = reader.getCellData("LeadRBAFilters_TC12_2", "No. of Employees", rowNum);
				String Country = reader.getCellData("LeadRBAFilters_TC12_2", "Country", rowNum);
				String Discription = reader.getCellData("LeadRBAFilters_TC12_2", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("LeadRBAFilters_TC12_2", "ExpectedResult", rowNum);
