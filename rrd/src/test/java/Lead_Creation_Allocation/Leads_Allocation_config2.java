...
public class Leads_Allocation_config2 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_Config2.html");
	...
	public void LeadCreation_config2() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("Lead_Allocation_config2");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Phone = reader.getCellData("Lead_Allocation_config2", "Phone", rowNum);
				String LastName = reader.getCellData("Lead_Allocation_config2", "Last Name", rowNum);
				String Company = reader.getCellData("Lead_Allocation_config2", "Company", rowNum);
				String LeadStatus = reader.getCellData("Lead_Allocation_config2", "Lead Status", rowNum);
				String Country = reader.getCellData("Lead_Allocation_config2", "Country", rowNum);
				String Discription = reader.getCellData("Lead_Allocation_config2", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("Lead_Allocation_config2", "ExpectedResult", rowNum);
				String TeamName = reader.getCellData("Lead_Allocation_config2", "TeamName", rowNum);
				String ToBeAssigned = reader.getCellData("Lead_Allocation_config2", "ToBeAssigned", rowNum);
