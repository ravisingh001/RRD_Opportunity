...
public class ExistingOpportunity_TC06 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_ExistingOpportunity_TC06.html");
		logger = report.startTest("Verify Lead Creation ExistingOpportunity_TC06");
	...
	@Test
	public void LeadCreation_ExistingOpportunity_TC06() throws InterruptedException {
		...
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			...
			try {
				String Amount = reader.getCellData("ExistingOpportunity_TC06", "Amount", rowNum);
				String Closedate = reader.getCellData("ExistingOpportunity_TC06", "Close date", rowNum);
				String Stages = reader.getCellData("ExistingOpportunity_TC06", "Stages", rowNum);
				String OpportunityName = reader.getCellData("ExistingOpportunity_TC06", "Opportunity Name", rowNum);
				String AccountName = reader.getCellData("ExistingOpportunity_TC06", "Account Name", rowNum);
				String Ratingtype = reader.getCellData("ExistingOpportunity_TC06", "Ratingtype", rowNum);
				String RRD_Type = reader.getCellData("ExistingOpportunity_TC06", "RRD_Type", rowNum);
				String RRD_LeadSource = reader.getCellData("ExistingOpportunity_TC06", "RRD_LeadSource", rowNum);
		...
		for (int RowNum = 2; RowNum <= RowCount; RowNum++) {
			...
			try {
				String Phone = Reader.getCellData("ExistingOpportunity_TC06", "Phone", RowNum);
