...
public class LeadRBAFilters_TC09 {
	WebDriver driver;
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_LeadRBAFilters_TC09.html");
		logger = report.startTest("Verify Lead Creation LeadRBAFilters_TC09");
	...
	@Test
	public void LeadCreation_LeadRBAFilter_TC09() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("LeadRBAFilters_TC09_1");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Phone = reader.getCellData("LeadRBAFilters_TC09_1", "Phone", rowNum);
				String LastName = reader.getCellData("LeadRBAFilters_TC09_1", "Last Name", rowNum);
				String Company = reader.getCellData("LeadRBAFilters_TC09_1", "Company", rowNum);
				String LeadStatus = reader.getCellData("LeadRBAFilters_TC09_1", "Lead Status", rowNum);
				String Country = reader.getCellData("LeadRBAFilters_TC09_1", "Country", rowNum);
				String Discription = reader.getCellData("LeadRBAFilters_TC09_1", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("LeadRBAFilters_TC09_1", "ExpectedResult", rowNum);
		...
		int RowCount = reader.getRowCount("LeadRBAFilters_TC09_2");
		for (int rowNum = 2; rowNum <= RowCount; rowNum++) {

			try {
				String Phone = reader.getCellData("LeadRBAFilters_TC09_2", "Phone", rowNum);
				String LastName = reader.getCellData("LeadRBAFilters_TC09_2", "Last Name", rowNum);
				String Company = reader.getCellData("LeadRBAFilters_TC09_2", "Company", rowNum);
				String LeadStatus = reader.getCellData("LeadRBAFilters_TC09_2", "Lead Status", rowNum);
				String Country = reader.getCellData("LeadRBAFilters_TC09_2", "Country", rowNum);
				String Discription = reader.getCellData("LeadRBAFilters_TC09_2", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("LeadRBAFilters_TC09_2", "ExpectedResult", rowNum);
