...
public class LeadFields_TC12 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/LeadCreation_LeadFields_TC12.html");
		logger = report.startTest("Verify Lead Creation LeadFields_TC12");
	...
	@Test
	public void LeadCreation_LeadFields_TC12() throws InterruptedException {
		...
		int rowCount = reader.getRowCount("LeadFields_TC12_1");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {

			try {
				String Phone = reader.getCellData("LeadFields_TC12_1", "Phone", rowNum);
				String LastName = reader.getCellData("LeadFields_TC12_1", "Last Name", rowNum);
				String Company = reader.getCellData("LeadFields_TC12_1", "Company", rowNum);
				String Rating = reader.getCellData("LeadFields_TC12_1", "Rating", rowNum);
				String LeadStatus = reader.getCellData("LeadFields_TC12_1", "Lead Status", rowNum);
				String Country = reader.getCellData("LeadFields_TC12_1", "Country", rowNum);
				String Discription = reader.getCellData("LeadFields_TC12_1", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("LeadFields_TC12_1", "ExpectedResult", rowNum);
		...
		int RowCount = reader.getRowCount("LeadFields_TC12_2");
		for (int rowNum = 2; rowNum <= RowCount; rowNum++) {

			try {
				String Phone = reader.getCellData("LeadFields_TC12_2", "Phone", rowNum);
				String LastName = reader.getCellData("LeadFields_TC12_2", "Last Name", rowNum);
				String Company = reader.getCellData("LeadFields_TC12_2", "Company", rowNum);
				String LeadStatus = reader.getCellData("LeadFields_TC12_2", "Lead Status", rowNum);
				String Rating = reader.getCellData("LeadFields_TC12_1", "Rating", rowNum);
				String Country = reader.getCellData("LeadFields_TC12_2", "Country", rowNum);
				String Discription = reader.getCellData("LeadFields_TC12_2", "Discription", rowNum);
				String ExpectedResult = reader.getCellData("LeadFields_TC12_2", "ExpectedResult", rowNum);
