...
public class Opp_caseconfig80 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Opp_CaseConfiguration80.html");
		logger = report.startTest("Verify Opp Case Configuration80");
	...
	@Test
	public void TestCaseConfig80() throws InterruptedException{

		Xls_Reader reader = new Xls_Reader(Opp_Testdata_sheet_path);
		
		int rowCount = reader.getRowCount("Opp_caseconfig80");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++)
		{
		
		String sUser1=reader.getCellData("Opp_caseconfig80", "Opp_Enable_RRD_Users" , rowNum);
		String sOwnerNotification=reader.getCellData("Opp_caseconfig80", "Opp_ownerNotification", rowNum);
		String sReleationshipBasedAssignment=reader.getCellData("Opp_caseconfig80", "Opp_Rel_Based_Asgmt", rowNum);
