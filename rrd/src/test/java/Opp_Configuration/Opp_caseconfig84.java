...
public class Opp_caseconfig84 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Opp_CaseConfiguration84.html");
		logger = report.startTest("Verify Opp Case Configuration84");
	...
	public void TestCaseConfig1() throws InterruptedException{
		...
		int rowCount = reader.getRowCount("Opp_caseconfig84");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++)
		{
		
		String sUser1=reader.getCellData("Opp_caseconfig84", "Opp_Enable_RRD_Users" , rowNum);
		String sOwnerNotification=reader.getCellData("Opp_caseconfig84", "Opp_ownerNotification", rowNum);
		String sReleationshipBasedAssignment=reader.getCellData("Opp_caseconfig84", "Opp_Rel_Based_Asgmt", rowNum);
