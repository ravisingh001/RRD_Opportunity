...
public class Opp_caseconfig82 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Opp_CaseConfiguration82.html");
		logger = report.startTest("Verify Opp Case Configuration82");
	...
	@Test
	public void TestCaseConfig82() throws InterruptedException{

		Xls_Reader reader = new Xls_Reader(Opp_Testdata_sheet_path);
		
		int rowCount = reader.getRowCount("Opp_caseconfig82");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++)
		{
		
		String sUser1=reader.getCellData("Opp_caseconfig82", "Opp_Enable_RRD_Users" , rowNum);
		String sOwnerNotification=reader.getCellData("Opp_caseconfig82", "Opp_ownerNotification", rowNum);
		String sReleationshipBasedAssignment=reader.getCellData("Opp_caseconfig82", "Opp_Rel_Based_Asgmt", rowNum);
