...
public class Opp_caseconfig6 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Opp_CaseConfiguration6.html");
		logger = report.startTest("Verify Opp Case Configuration6");
	...
	public void TestCaseConfig1() throws InterruptedException{
		...
		int rowCount = reader.getRowCount("Opp_caseconfig6");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++)
		{
		
		String sUser1=reader.getCellData("Opp_caseconfig6", "Opp_Enable_RRD_Users" , rowNum);
		String sOwnerNotification=reader.getCellData("Opp_caseconfig6", "Opp_ownerNotification", rowNum);
		String sReleationshipBasedAssignment=reader.getCellData("Opp_caseconfig6", "Opp_Rel_Based_Asgmt", rowNum);
