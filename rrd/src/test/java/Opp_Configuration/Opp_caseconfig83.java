...
public class Opp_caseconfig83 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Opp_CaseConfiguration83.html");
		logger = report.startTest("Verify Opp Case Configuration83");
	...
	public void TestCaseConfig1() throws InterruptedException{
		...
		int rowCount = reader.getRowCount("Opp_caseconfig83");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++)
		{
		
		String sUser1=reader.getCellData("Opp_caseconfig83", "Opp_Enable_RRD_Users" , rowNum);
		String sOwnerNotification=reader.getCellData("Opp_caseconfig83", "Opp_ownerNotification", rowNum);
		String sReleationshipBasedAssignment=reader.getCellData("Opp_caseconfig83", "Opp_Rel_Based_Asgmt", rowNum);
		...
		/*
		 * step1ConfigPage.unCheckQueueAssignmentCheckbox(); logger.log(LogStatus.INFO,
		 * "Uncheck Queue assignment checkbox");
		 * 
		 ...
		 * 
		 * step1ConfigPage.ClearCasePriority(); logger.log(LogStatus.INFO,
		 * "clear case Priority");
		 */
