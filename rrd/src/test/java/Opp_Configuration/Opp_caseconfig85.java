...
public class Opp_caseconfig85 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Opp_CaseConfiguration85.html");
		logger = report.startTest("Verify Opp Case Configuration85");
	...
	public void TestCaseConfig1() throws InterruptedException{
		...
		int rowCount = reader.getRowCount("Opp_caseconfig85");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++)
		{
		
		String sUser1=reader.getCellData("Opp_caseconfig85", "Opp_Enable_RRD_Users" , rowNum);
		String sOwnerNotification=reader.getCellData("Opp_caseconfig85", "Opp_ownerNotification", rowNum);
		String sReleationshipBasedAssignment=reader.getCellData("Opp_caseconfig85", "Opp_Rel_Based_Asgmt", rowNum);
