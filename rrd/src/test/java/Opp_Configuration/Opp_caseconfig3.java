...
public class Opp_caseconfig3 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Opp_CaseConfiguration3.html");
		logger = report.startTest("Verify Opp Case Configuration3");
	...
	public void TestCaseConfig3() throws InterruptedException{
		...
		int rowCount = reader.getRowCount("Opp_caseconfig3");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++)
		{
		
		String sUser1=reader.getCellData("Opp_caseconfig3", "Opp_Enable_RRD_Users" , rowNum);
		String sOwnerNotification=reader.getCellData("Opp_caseconfig3", "Opp_ownerNotification", rowNum);
		String sReleationshipBasedAssignment=reader.getCellData("Opp_caseconfig3", "Opp_Rel_Based_Asgmt", rowNum);
