...
public class Opp_caseconfig4 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/Opp_CaseConfiguration4.html");
		logger = report.startTest("Verify Opp Case Configuration4");
	...
	public void TestCaseConfig1() throws InterruptedException{
		...
		int rowCount = reader.getRowCount("Opp_caseconfig4");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++)
		{
		
		String sUser1=reader.getCellData("Opp_caseconfig4", "Opp_Enable_RRD_Users" , rowNum);
		String sOwnerNotification=reader.getCellData("Opp_caseconfig4", "Opp_ownerNotification", rowNum);
		String sReleationshipBasedAssignment=reader.getCellData("Opp_caseconfig4", "Opp_Rel_Based_Asgmt", rowNum);
